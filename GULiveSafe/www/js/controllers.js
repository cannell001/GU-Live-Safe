...
//Current Report for ReportAn Incident Code
.controller('ic_c_reportsCtrl', ['$scope', '$stateParams','$http', '$ionicHistory', '$ionicLoading', '$ionicPopup', '$ionicViewSwitcher',
function ($scope, $stateParams, $http, $ionicHistory, $ionicLoading, $ionicPopup, $ionicViewSwitcher) {
...
$http.get("http://gulivesafe.com/current_incident_reports.php?name=current_incident&email_id="+window.localStorage.getItem("loggedin_email"))
            .success(function(data) {

              $ionicLoading.hide();
              $scope.incident_c_report = data;
...
//ReportAnIncident History Controller Code...

.controller('ic_historyCtrl', ['$scope', '$stateParams','$http', '$ionicHistory', '$ionicLoading', '$ionicViewSwitcher',
function ($scope, $stateParams, $http, $ionicHistory, $ionicLoading, $ionicViewSwitcher) {
...
$http.get("http://gulivesafe.com/current_incident_reports.php?name=completed_incident&email_id="+window.localStorage.getItem("loggedin_email"))
            .success(function(data) {

              $ionicLoading.hide();
              $scope.incident_report_history = data;
